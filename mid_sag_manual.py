...
class Midsag:
    ...
    def __init__(self, data):
        ...
        self.fig.canvas.mpl_connect('button_press_event', self.clicked_on_bar)
        self.fig.canvas.mpl_connect('button_release_event', self.released_on_bar)
    ...
    def released_on_bar(self, event):
        if event.button == 1:
            if event.xdata and hasattr(self, 'ran'):
